...
// private static final HashMap<Integer, AprilTag> aprilTagMap = new
// HashMap<>();
...
// Left(APRIL_TAGS.CORAL_STATION_LEFT_TAGID,
// APRIL_TAGS.CORAL_STATION_LEFT_OFFSET),
// Right(APRIL_TAGS.CORAL_STATION_RIGHT_TAGID,
// APRIL_TAGS.CORAL_STATION_RIGHT_OFFSET);
...
// value.m_next = next_index == value_list.length ? first :
// value_list[next_index];
...
// public void setDriveSubsystem(CommandSwerveDrivetrain driveSubsystem, double
// driveMaxSpeed,
...
// double targetingAngularVelocity = LimelightHelpers.getTX(limelightOneName) *
// kP;
...
// private final PIDController limelightRangeController = new
// PIDController(rangePID_P, 0, 0);
...
// limelightRangeController.calculate(LimelightHelpers.getTY(limelightOneName),
// targetTagRange);
...
// LimelightHelpers.SetRobotOrientation(limelightName, yaw_degrees, 0, 0, 0, 0,
// 0);
...
// final boolean insideReefZone = distance <=
// APRIL_TAGS.INSIDE_REEF_ZONE_THRESHOLD;
...
// if (useMegaTag2) {
// SmartDashboard.putBoolean("MegaTag2SuccessOne",
// updateVisionMegaTag2(limelightOneName));
// if (useLimelightTwo)
// SmartDashboard.putBoolean("MegaTag2SuccessTwo",
// updateVisionMegaTag2(limelightTwoName));
// } else {
...
// private final PIDController targetRotatePIDController = new PIDController(3,
// 0, 0);
...
// double desiredAngle =
// targetTagPose.getRotation().minus(robotPose.getRotation()).getRadians();
// SmartDashboard.putNumber("ROTATEFROMTAG_DESIREDANGLE", desiredAngle);

// double result =
// targetRotatePIDController.calculate(robotPose.getRotation().getRadians(),
// desiredAngle);
// SmartDashboard.putNumber("ROTATEFROMTAG_RESULT", result);
// return result;
// }

// public Translation2d getReefTagDirectionVector(Translation2d
// targetTagTranslation) {
// Translation2d directionVector =
// targetTagTranslation.minus(reefCenterTranslation); // get vector from center
// of
// // reef to tag
// final double directionVectorMagnitude = Math
// .sqrt(Math.pow(directionVector.getX(), 2) + Math.pow(directionVector.getY(),
// 2)); // get magnitude
// directionVector = new Translation2d(directionVector.getX() /
// directionVectorMagnitude,
...
// final Translation2d directionVector =
// getReefTagDirectionVector(targetTagTranslation);

// Pose2d targetPose = new Pose2d(
// new Translation2d(targetTagTranslation.getX() + directionVector.getX() *
// offset,
...
// public Command getPathCommandFromCoralStationTag(CoralStationID
// coralStationID) {
// // this code gets the target april tag position and applies a certain offset
